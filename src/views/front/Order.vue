        ...
        <div class="card mb-2" v-for="cartItem in cartData.carts" :key="cartItem.id">
          <div class="row g-0">
            ...
            <div class="col-6 text-dark">
              <div class="card-body d-flex flex-column justify-content-between h-100 py-0 px-2">
          ...
          <div class="input-group mb-4">
            ...
            <button class="btn btn-outline-primary py-2" type="button" :disabled="isSpinner || couponCode === ''"
          ...
          <Form class="py-3" v-slot="{ errors }" @submit="addOrder">
            <div class="mb-3">
              ...
              <Field type="email" class="form-control" id="Email" name="Email" placeholder="請輸入 Email"
                v-model="formData.user.email" :class="{ 'is-invalid': errors['Email'] }" rules="email|required" />
            ...
            <div class="mb-3">
              ...
              <Field type="text" class="form-control" id="name" name="收件人" placeholder="請輸入姓名"
                v-model="formData.user.name" :class="{ 'is-invalid': errors['收件人'] }" rules="required" />
              <ErrorMessage name="收件人" class="invalid-feedback" />
            </div>
            <div class="mb-3">
              ...
              <Field type="tel" class="form-control" id="tel" name="電話" placeholder="請輸入電話"
                v-model="formData.user.tel" :class="{ 'is-invalid': errors['電話'] }" :rules="isPhone" />
            ...
            <div class="mb-3">
              ...
              <Field type="text" class="form-control" id="address" name="收件地址" placeholder="請輸入收件地址"
                v-model="formData.user.address" :class="{ 'is-invalid': errors['收件地址'] }" rules="required" />
              <ErrorMessage name="收件地址" class="invalid-feedback" />
            </div>
            <div class="mb-4">
              <label for="message" class="form-label">留言</label>
              <Field type="text" class="form-control" id="message" name="留言" cols="30" rows="10"
                v-model="formData.message" as="textarea" />
            </div>
            <div class="text-end">
              <button type="submit" class="btn btn-primary w-100 w-lg-25 py-2"
